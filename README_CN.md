...
- 📚 **内置题库**：2014–2025 年 41 套软考软件设计师历年真题 — 共 1579 道题：1483 道选择题 + 96 道案例题，案例题再细分为 263 道小问；已通过 AI 自动归类到 56 个叶子知识点；自部署跑一遍 `db:seed` 即可直接刷题。
...
打开 `http://localhost:3000`，注册第一个账号即可开始使用。`db:seed` 会从 `data/51cto-seed.json`（由 `data/51cto-exams/` 转换得到）写入 41 套真题 / 共 1579 道题（1483 道选择题 + 96 道案例题，案例题细分为 263 道小问），数据来源与处理流水线见 `data/51cto-exams/INDEX.md`。
...
- [ ] 更多软考科目支持（信息系统项目管理师等）
- [x] 历年真题内置（2014–2025，41 套，1579 题：1483 选择题 + 96 道案例题 / 263 小问）
- [ ] PostgreSQL 生产部署支持
- [ ] Docker Compose 一键部署
- [ ] 国际化（i18n）
