...
> 产品截图占位：公开 Demo 稳定后，可在这里放置 Dashboard、练习页和 AI 讲解截图。
...
| 模块         | 预览                                     |
| ------------ | ---------------------------------------- |
| Dashboard    | 学习进度、通过概率、知识点热力图截图占位 |
| Practice     | 选择题和案例分析练习截图占位             |
| AI assistant | AI 讲解、批改、诊断截图占位              |
| Desktop app  | Tauri 桌面版截图占位                     |
