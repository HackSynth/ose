...
Markdown 格式规则（必须严格遵守）：
- 章节标题使用 ## 或 ###，禁止用 "1. 标题" 的形式作为标题
- 表格使用 GitHub Flavored Markdown 管道表格，例如：| 列1 | 列2 |\n|---|---|\n| 值1 | 值2 |
- 公式和数学表达式使用代码块（\`\`\`text ... \`\`\`）或行内代码（\`...\`），禁止使用 LaTeX 格式（如 \\frac{}{}、\\boxed{} 或 [ ... ] 括起来的 LaTeX 片段）
- 最终答案使用引用块强调，例如：> **正确答案：B**
- 禁止输出任何 HTML 标签
...
Markdown 格式规则（必须严格遵守）：
- 章节标题使用 ## 或 ###
- 表格使用 GitHub Flavored Markdown 管道表格
- 公式和数学表达式使用代码块或行内代码，禁止使用 LaTeX 格式
- 禁止输出任何 HTML 标签
...
Markdown 格式规则（必须严格遵守）：
- 章节标题使用 ## 或 ###
- 如有表格，使用 GitHub Flavored Markdown 管道表格
- 禁止输出任何 HTML 标签
...
Markdown 格式规则（必须严格遵守）：
- 章节标题使用 ## 或 ###
- 清单使用 Markdown 无序列表（- item）或有序列表（1. item）
- 禁止输出任何 HTML 标签
